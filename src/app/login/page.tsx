...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen p-3 sm:p-8 flex items-center justify-center">
      <div className="w-full max-w-md rounded-2xl glass-card p-6 sm:p-8">
        ...
        <form className="mt-5 space-y-4" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-[var(--accent)] text-white font-semibold py-2.5 disabled:opacity-60 action-btn"
          >
